<x-app-layout>
    <section class="py-12">
        <section class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <header name="header" class="fade-in delay-fast bg-white overflow-hidden shadow-sm sm:rounded-lg my-6 mx-4">
            ...
            <section class="flex flex-col md:flex-row gap-4 overflow-hidden sm:rounded-lg justify-between my-6 mx-4">                
                <section class="fade-in delay-slow bg-white shadow-sm sm:rounded-lg my-2 w-full md:w-1/2">
                    ...
                    @foreach ($loaningProducts as $product)
                        <section name="product" class="p-2 text-gray-900 m-2">
                            <a name="button" href="{{ route('products.show', $product->id) }}" 
